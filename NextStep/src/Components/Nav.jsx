  ...
  return (
    ...
    <div className=' h-18 bg-black text-white flex justify-between align-middle'>
      ...
      className="inline-block relative transform transition-transform duration-300 hover:scale-105 
          text-white hover:text-blue-600
          after:content-[''] after:block after:w-0 after:h-[2px] after:bg-blue-600 
          after:transition-all after:duration-300 hover:after:w-full text-xl font-foda">Find Skills</a></li>
      <li><a href="" 
      className="inline-block relative transform transition-transform duration-300 hover:scale-105 
          text-white hover:text-blue-600
          after:content-[''] after:block after:w-0 after:h-[2px] after:bg-blue-600 
          after:transition-all after:duration-300 hover:after:w-full text-xl font-foda">Post Skills</a></li>
      <li>
  <Link 
    to="/findjobs"
    className="inline-block relative transform transition-transform duration-300 hover:scale-105 
      text-white hover:text-blue-600 after:content-[''] after:block after:w-0 after:h-[2px] 
      after:bg-blue-600 after:transition-all after:duration-300 hover:after:w-full text-xl font-foda"
  >
    Find Job
  </Link>
</li>
